...
- Less than 5% daily: Widely acceptable (90%+ users)  
...
- Target: 70% of proofs on-device, less than 60s generation time  
...
- Target: 90% of proofs on-device, 60% less than 30s, 30% 30-120s  
...
- Target: 95% on-device, 80% less than 15s  
...
- Target: 98% on-device, 90% less than 5s  
...
| Sybil Attack (Mass Fake Accounts) | Create hundreds of fake users | Blockchain anchoring (costs to create accounts), proof-of-work on registration, social graph analysis (fake accounts have distinct patterns), gradual privilege escalation (new users have lower trust) | less than 1% | High (doesn't scale economically) |
...
- **Right to be forgotten:** Full data deletion in less than 30 days  
...
- Aggressive battery optimisation (must be less than 7% daily by this phase)  
...
- Mitigation:  
  - Aggressive optimisation roadmap (target less than 5% by Year 5\)  
  - Tiered tracking modes (light/medium/full)  
...
- ZKP generation: 70% on-device less than 60s (Year 1\) → 95% less than 15s (Year 5\) → 98% less than 5s (Year 10\)
...
*Test modification by Claude Code - Thu Oct 23 12:22:18 AM UTC 2025*
